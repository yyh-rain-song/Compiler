...
public class SimpleGraphAllocator {
    ...
    private void showFunction(Function function) {
        LivenessAnalyzer.Graph graph = new LivenessAnalyzer.Graph();
    ...
    Function function;
    LivenessAnalyzer.Graph orignGraph;
    ...
    private void processFunction() {
        orignGraph = new LivenessAnalyzer.Graph();
        while(true) {
//            showFunction(function);

            livenessAnalyzer.getInferenceGraph(function, orignGraph, null);
            graph = new LivenessAnalyzer.Graph(orignGraph);
            init();
            do {
