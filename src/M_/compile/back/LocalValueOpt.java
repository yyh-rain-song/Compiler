...
import static M_.IR.Instruction.BinaryInst.BinaryOp.*;
import static M_.IR.RegisterSet.vrax;
import static M_.IR.RegisterSet.vrdx;

public class LocalValueOpt implements IIRVisitor {
    private IRProgram irProgram;
    private Integer curValueNumber;
    private HashMap<VirtualRegister,Integer> registerValueMap = new HashMap<>();
    private HashMap<Pair, Integer> pairValueMap = new HashMap<>();
    private HashMap<Integer, Integer> immediateValueMap = new HashMap<>();
    private HashMap<Integer, HashSet<VirtualRegister>> valueRegisterMap = new HashMap<>();
    private HashMap<Integer, Integer> valueImmediateMap = new HashMap<>();

    public LocalValueOpt(IRProgram irProgram) {
