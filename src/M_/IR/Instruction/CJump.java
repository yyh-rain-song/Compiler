...
public class CJump extends IRInstruction {
    ...
    public CompareOp getReverseCompareOp() {
        switch(op) {
            case E: return CompareOp.E;
            case G: return CompareOp.LE;
            case L: return CompareOp.GE;
            case GE: return CompareOp.L;
            case LE: return CompareOp.G;
            case NE: return CompareOp.NE;
            default: assert false; return CompareOp.E;
        }
    }

    public CompareOp getNegativeCompareOp() {
        switch (op) {
            case NE: return CompareOp.E;
            case LE: return CompareOp.G;
            case GE: return CompareOp.L;
            case L: return CompareOp.GE;
            case G: return CompareOp.LE;
            case E: return CompareOp.NE;
            default: assert false; return CompareOp.E;
        }
